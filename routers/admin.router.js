...
const { getAllStaffHandler, createStaffUserHandler, updateStaffHandler, deleteStaffHandler, getAllUsersHandler, removeUserHandler } = require("../controllers/admin.controller");
...
router.route("/users").get(hasPermission("canManageUsers"), getAllUsersHandler)
